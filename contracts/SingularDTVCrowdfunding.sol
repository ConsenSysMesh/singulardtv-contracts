...
contract SingularDTVCrowdfunding {
    ...
    uint constant public CROWDFUNDING_PERIOD = 5 days; // 1 month
    uint constant public TOKEN_LOCKING_PERIOD = 2 days; // 2 years
    uint constant public TOKEN_TARGET = 502000000; // 34M Tokens more than the initial 500M, around 42,500 ETH
